...
abstract class GatewayAdapter implements GatewayType {
	...
	function runPreProcessHooks() {
		...
		if ( $this->getValidationAction() == 'challenge' ) {
			...
			runHooks( 'GatewayChallenge', $this );
		}
	...
	protected function runPostProcessHooks() {
		...
		runHooks( 'GatewayPostProcess', $this ); //conversion log (at least)
	}

	protected function runHandoffHooks($options = array()) {
		runHooks( 'GatewayHandoff', $this, $options );
	}
